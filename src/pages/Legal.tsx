...
export const Privacy = () => (
  <LegalPage title="Politica della Privacy" updated="Ultimo aggiornamento: Gennaio 2026">
...
export const Rimborsi = () => (
  <LegalPage title="Politica di Rimborso" updated="Ultimo aggiornamento: Gennaio 2026">
    <h2>Premessa</h2>
...
export const Termini = () => (
  <LegalPage title="Termini e Condizioni" updated="Ultimo aggiornamento: Gennaio 2026">
