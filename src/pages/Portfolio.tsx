...
const Portfolio = () => {
  ...
  const categories = [
    ...
    { key: "brand",         label: t(P.filters.brand) },
  ...
  const projects = [
    ...
    { sig: "LoS", cat: "brand",         client: "Lab On Sense",         headline: t(P.p3_headline), desc: t(P.p3_body), tags: ["Sito Web", "Brand Identity", "UX"] },
    { sig: "AR",  cat: "community",     client: "Arkes Roleplay",       headline: t(P.p4_headline), desc: t(P.p4_body), tags: ["Community Management", "Discord"] },
    { sig: "TD",  cat: "brand",         client: "TDSTUDIO",             headline: t(P.p5_headline), desc: t(P.p5_body), tags: ["Branding", "Social", "Positioning"] },
